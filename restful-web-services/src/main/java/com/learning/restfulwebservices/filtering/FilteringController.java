...
public class FilteringController {
    ...
    public MappingJacksonValue getSomeBean(){
        ...
        SimpleBeanPropertyFilter filter = SimpleBeanPropertyFilter.filterOutAllExcept("valueOne","valueTwo");
    ...
    public MappingJacksonValue getSomeBeans(){
        ...
        SimpleBeanPropertyFilter filter = SimpleBeanPropertyFilter.filterOutAllExcept("valueOne","valueThree");
        FilterProvider filters = new SimpleFilterProvider().addFilter("SomeBeanFilter",filter);
        mapping.setFilters(filters);
        return mapping;
    }
